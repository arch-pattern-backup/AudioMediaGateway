...
# 1. Conditional Windows Versioning Imports
version_info = None
if sys.platform == 'win32':
    try:
        ...
        # Define version info only for Windows builds
...
# Collect all for mutagen, boto3, and botocore
for pkg in ['mutagen', 'boto3', 'botocore']:
